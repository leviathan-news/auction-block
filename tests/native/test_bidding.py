...
def test_minimum_total_bid_no_bids(auction_house_with_auction):
    ...
    assert min_bid == house.reserve_price(), "Minimum bid should equal reserve price when no bids exist"
...
def test_minimum_additional_bid_no_bids(auction_house_with_auction, alice):
    ...
    assert min_additional == house.reserve_price(), "Minimum additional bid should equal reserve price for new bidder"
...
def test_minimum_additional_bid_with_pending_returns(auction_house_with_auction, alice, bob, payment_token):
    ...
    min_additional = house.minimum_additional_bid_for_user(auction_id, alice)
    assert min_additional == expected_additional, f"Expected minimum additional bid {expected_additional}, got {min_additional}"
