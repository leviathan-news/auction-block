...
def test_extreme_parameter_scenarios(auction_house):
    ...
    test_scenarios = [
        {
            "name": "Zero Time Buffer",
            "params": [0, 10**18, 5, 3600, ""]
        },
        {
            "name": "Extremely High Reserve Price",
            "params": [3600, 2**256 - 1, 5, 3600, ""]
        },
        {
            "name": "Minimal Duration",
            "params": [3600, 10**18, 5, 3600, ""]
        },
        {
            "name": "Zero Reserve Price",
            "params": [3600, 0, 5, 3600, ""]
        }
    ]
