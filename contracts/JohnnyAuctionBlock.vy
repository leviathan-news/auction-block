...
# @note -- i'd consider nuking this and getting current auctions offchain using events (see https://github.com/leviathan-news/auction-bot/blob/main/src/chain/events.py#L28)
@external
@view
...
def create_bid(
    ...
    """
    # self._check_caller(on_behalf_of, msg.sender, ApprovalStatus.BidOnly) @note -- only directory should be able to call
...
# @note -- only directory should be able to call
@external
@nonreentrant
...
# @note -- only caller should be dir
# @external
